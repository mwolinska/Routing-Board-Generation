...
from numpy_data_model.board_generator_data_model import Position
...
def extend_wires_jax(board_layout: Array, key: PRNGKey, randomness: float = 0.0, max_iterations: int = 1e23) -> Array:
    ...
    while ~jax.numpy.equal(prev_layout, board_layout):
    """
    def while_cond(carry):
        prev_layout, board_layout, _ = carry
        return ~jax.numpy.array_equal(prev_layout, board_layout)
