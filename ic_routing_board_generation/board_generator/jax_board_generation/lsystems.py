...
import ic_routing_board_generation.board_generator.grid_utils as grid_utils
from ic_routing_board_generation.board_generator.post_processing_utils import extend_wires_jax
...
class LSystemBoardGen:
    ...
    def find_empty_neighbours(self, loc: Tuple[int, int], agents: List[Agent]) -> tuple[chex.Array, chex.Array]:
    ...
    def fill(self,
             key: random.PRNGKey,
             agents: List[Agent]) -> Tuple[random.PRNGKey, List[Agent]]:
    ...
    def fill_method_inner(self, i, inp) -> Tuple[random.PRNGKey, List[Agent]]:
    ...
    def fill_method(self, inp) -> Tuple[random.PRNGKey, List[Agent]]:
        return jax.lax.fori_loop(0, self.n_iters, self.fill_method_inner, inp)

    def fill_unsolved_board(self, agents: Agent) -> chex.Array:
    ...
    def fill_solved_board(self, agents: List[Agent]) -> np.ndarray:
