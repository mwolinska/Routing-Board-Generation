    ...
    def while_body(carry):
        ...
        def row_func(row, carry):
            ...
            def col_func(col, carry):
                ...
                poss_extension_list = get_open_adjacent_cells_jax(
                ...
                poss_extension_list = jax.lax.select(
                    is_extendable, poss_extension_list, INVALID4
                )
...
def num_wire_adjacencies_jax(
    input_pos: jnp.array, wire_num: Array, board_layout: Array
) -> Array:
