...
parser.add_argument("--number_of_boards", default=20, type=int)
parser.add_argument("--board_size", default=10, type=int)
parser.add_argument("--num_agents", default=5, type=int)
parser.add_argument("--remove_figs", default=True, type=bool)
...
if __name__ == "__main__":
    ...
    evaluate_generator_outputs_averaged_on_n_boards(
        board_list, number_of_boards=args.number_of_boards, plot_individually=False
    )
